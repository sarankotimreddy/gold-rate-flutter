        ...
        child: Container(
          ...
          child: Column(
            children: [
              ...
              _buildEditableRow("100Gr", "Mc100g", vm.hPrice, vm, true),
              _buildEditableRow("50Gr", "Mc50g", vm.fPrice, vm, false),
              _buildEditableRow("31.10Gr", "Mc31.10g", vm.ozPrice, vm, true),
              _buildEditableRow("20Gr", "Mc20g", vm.twPrice, vm, false),
              _buildEditableRow("10Gr", "Mc10g", vm.tePrice, vm, true),
              _buildEditableRow("5Gr", "Mc5g", vm.fiPrice, vm, false),
              _buildEditableRow("2.50Gr", "Mc2.5g", vm.tfPrice, vm, true),
              _buildEditableRow("1Gr", "Mc1g", vm.oPrice, vm, false),
              _buildEditableRow("72Gr", "Mc72g", vm.maPrice, vm, true),
              _buildEditableRow("36Gr", "Mc36g", vm.muPrice, vm, false),
              _buildEditableRow("18Gr", "Mc18g", vm.nmPrice, vm, true),
              _buildEditableRow("8Gr", "Mc8g", vm.gPrice, vm, false),
              _buildEditableRow("7.20Gr", "Mc7.2g", vm.lPrice, vm, true),
              _buildEditableRow("3.60Gr", "Mc3.6g", vm.hlPrice, vm, false),
              _buildEditableRow("1.80Gr", "Mc1.8g", vm.rlPrice, vm, true),
              _buildEditableRow("0.90Gr", "Mc0.9g", vm.blPrice, vm, false),
            ],
          ),
        ),
      ),
